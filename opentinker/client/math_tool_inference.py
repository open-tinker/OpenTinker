...
@hydra.main(
    ...
    config_name="math_code_interpreter_inference_config.yaml",
    version_base=None,
)
def main(args):
    ...
    if game_stats.health_check():
        ...
        print(
            "  Make sure to start: python opentinker/environment/math/code_interpreter_math_server.py --port 8088"
        )
        game_stats = None
    ...
    print(
        f"  - Multi-turn: max_user_turns={args.multi_turn.max_user_turns}, max_assistant_turns={args.multi_turn.max_assistant_turns}"
    )
    print(
