...
"""
Actor Config - Patched for on-policy distillation support.

Original file: verl/verl/workers/config/actor.py

Changes from original:
- Added distillation fields to FSDPActorConfig:
  - use_distillation: bool
  - distillation_mode: str
  - distillation_kl_type: str
"""
...
class FSDPActorConfig(ActorConfig):
    ...
    Args:
        ...
        use_distillation (bool): Whether to use distillation loss instead of RL loss.
        distillation_mode (str): Distillation mode - 'pure' for KL-only loss.
        distillation_kl_type (str): KL type - 'forward' or 'reverse'.
    """
    ...
    # ===== DISTILLATION PATCH: add distillation config fields =====
